...
```mermaid
flowchart LR
    subgraph Iter1["Iter 1: Batch=3"]
        R1A[Req1: P512]
        R2A[Req2: P1024]
        R3A[Req3: P2048]
    end
    
    subgraph Iter2["Iter 2: Batch=4"]
        R1B[Req1: D513]
        R2B[Req2: D1025]
        R3B[Req3: D2049]
        R4A[Req4: P256<br/>JOINS]
    end
    
    subgraph Iter3["Iter 3: Batch=5"]
        R2C[Req2: D1026]
        R3C[Req3: D2050]
        R4B[Req4: D257]
        R5A[Req5: P128<br/>JOINS]
        R1C[Req1: D514]
    end
    
    Iter1 -->|Progress| Iter2
    Iter2 -->|New join| Iter3
